<?php $__env->startSection('title', 'Pengajuan Balik Nama'); ?>
            ...
            <tbody>
                ...
                <tr class="group hover:bg-slate-50 transition-colors">
                    <td class="py-4 px-4 border-b border-slate-50">
                        <span class="text-xs font-bold text-slate-500"><?php echo e($item->created_at->format('d/m/Y H:i')); ?></span>
                    </td>
                    <td class="py-4 px-4 border-b border-slate-50">
                        <span class="text-sm font-black text-slate-900"><?php echo e($item->nop); ?></span>
                    </td>
                    <td class="py-4 px-4 border-b border-slate-50">
                        <span class="text-sm font-bold text-slate-600"><?php echo e($item->nama_pemilik_lama); ?></span>
                    </td>
                    <td class="py-4 px-4 border-b border-slate-50">
                        <span class="text-sm font-black text-primary"><?php echo e($item->nama_pemilik_baru); ?></span>
                    </td>
                    <td class="py-4 px-4 border-b border-slate-50 text-center">
                        ...
                        ?>
                        <span class="inline-flex items-center gap-1.5 py-1 px-3 rounded-full text-[10px] font-black <?php echo e($class); ?> uppercase tracking-wider">
                            <?php echo e($item->status); ?>

                        </span>
                    </td>
                    <td class="py-4 px-4 border-b border-slate-50 text-right">
                        <a href="<?php echo e(route('admin.balik_nama.show', $item->id)); ?>" class="inline-flex items-center gap-2 bg-slate-100 text-slate-600 hover:bg-primary hover:text-white px-4 py-2 rounded-xl text-xs font-black transition-all">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pbb-cikeduk\resources\views/dashboard/balik_nama/index.blade.php ENDPATH**/ ?>