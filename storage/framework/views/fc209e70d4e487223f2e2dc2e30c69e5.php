...
<html>
<head>
    <title>SPPT PBB - <?php echo e($pbb->nop); ?></title>
    <style>
...
<body>
    <div class="header">
        <img src="data:image/jpeg;base64,<?php echo e(base64_encode(file_get_contents(public_path('logo.jpeg')))); ?>" class="logo">
    ...
    <table class="table">
        <tr>
            ...
            <td class="value"><strong><?php echo e($pbb->nop); ?></strong></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="value"><?php echo e($pbb->nama_wp); ?></td>
        </tr>
        <tr>
            <td class="label">ALAMAT WAJIB PAJAK</td>
            <td class="value"><?php echo e($pbb->alamat_wajib_pajak); ?></td>
        </tr>
        <tr>
            <td class="label">LETAK OBJEK PAJAK</td>
            <td class="value">BLOK: <?php echo e($pbb->blok ?? '-'); ?>, NO URUT: <?php echo e($pbb->no_urut ?? '-'); ?></td>
        </tr>
        <tr>
            <td class="label">LUAS TANAH / BUMI</td>
            <td class="value"><?php echo e($pbb->luas ?? '-'); ?> m2</td>
        </tr>
        <tr>
            <td class="label" style="background-color: #ddd;">TOTAL PAJAK TERHUTANG</td>
            <td class="value" style="font-size: 16px; font-weight: bold;">
                Rp <?php echo e(number_format($pbb->ketetapan_pbb, 0, ',', '.')); ?>
        ...
        <tr>
            ...
            <td class="value">
                <strong style="color: <?php echo e($pbb->status == 'Lunas' ? '#059669' : '#dc2626'); ?>">
                    <?php echo e(strtoupper($pbb->status ?? 'BELUM LUNAS')); ?>
    ...
    <div class="footer">
        <div class="signature-box">
            <div>Ditetapkan di Cikeduk, <?php echo e(date('d F Y')); ?></div>
    ...
    <div class="qr-code">
        <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=VALID_SPPT_<?php echo e($pbb->nop); ?>_<?php echo e($pbb->status); ?>" width="80">
    </div>
...
<?php /**PATH C:\xampp\htdocs\pbb-cikeduk\resources\views/landing/sppt_pdf.blade.php ENDPATH**/ ?>