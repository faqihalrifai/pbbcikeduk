            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div>
                    <div class="bg-white rounded-[2.5rem] p-10 shadow-premium border border-slate-50">
                        ...
                        <form action="<?php echo e(route('landing.complaint.store')); ?>" method="POST" class="space-y-6">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all">
                            <div class="flex justify-between items-start mb-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-black text-slate-900"><?php echo e($c->nama); ?></p>
                                        <p class="text-[10px] font-bold text-slate-400"><?php echo e($c->created_at->diffForHumans()); ?></p>
                                    </div>
                                </div>
                                ...
                                <?php else: ?>
                                <span class="text-[9px] font-black bg-orange-100 text-orange-600 px-3 py-1 rounded-full uppercase tracking-widest"><?php echo e($c->status); ?></span>
                                <?php endif; ?>
                            </div>
                            <h4 class="font-bold text-slate-800 text-sm mb-2"><?php echo e($c->judul); ?></h4>
                            <p class="text-slate-500 text-xs leading-relaxed line-clamp-2 italic">"<?php echo e($c->isi); ?>"</p>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\pbb-cikeduk\resources\views/landing/complaint.blade.php ENDPATH**/ ?>