<?php $__env->startSection('title', 'Dashboard Kolektor'); ?>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
    ...
    <div class="bg-white p-6 rounded-[2rem] shadow-premium border border-slate-50 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-2xl font-black text-slate-900">Rp <?php echo e(number_format($totalSetoran, 0, ',', '.')); ?></h3>
    ...
    <div class="bg-white p-6 rounded-[2rem] shadow-premium border border-slate-50 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-2xl font-black text-slate-900">Rp <?php echo e(number_format($setoranHariIni, 0, ',', '.')); ?></h3>
    ...
    <div class="bg-white p-6 rounded-[2rem] shadow-premium border border-slate-50 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-2xl font-black text-slate-900">Rp <?php echo e(number_format($jumlahTagihan, 0, ',', '.')); ?></h3>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="group hover:bg-slate-50/50 transition-colors">
                    <td class="py-4 px-8 text-xs font-black text-primary"><?php echo e($pay->tunggakan->wajibPajak->nop); ?></td>
                    <td class="py-4 px-4 text-sm font-black text-slate-900"><?php echo e($pay->tunggakan->wajibPajak->nama); ?></td>
                    <td class="py-4 px-4 text-sm font-black text-primary text-right">Rp <?php echo e(number_format($pay->jumlah_bayar, 0, ',', '.')); ?></td>
                    <td class="py-4 px-4 text-center text-xs font-bold text-slate-500"><?php echo e($pay->tanggal_bayar->format('d/m/Y')); ?></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pbb-cikeduk\resources\views/dashboard/collector.blade.php ENDPATH**/ ?>