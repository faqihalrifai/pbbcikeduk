...
<head>
    ...
    <title>Cetak Bukti Pembayaran - <?php echo e($payment->tunggakan->wajibPajak->nop ?? 'PBB'); ?></title>
    <!-- Google Fonts -->
    ...
    <div class="print-area bg-white w-full max-w-[800px] shadow-2xl p-10 md:p-16 border border-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 mb-12">
            <div>
                ...
                <p class="text-base font-black text-slate-900"><?php echo e($payment->tunggakan->wajibPajak->nop ?? '-'); ?></p>
            </div>
            <div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">ID Transaksi</p>
                <p class="text-base font-black text-slate-900">TRX-<?php echo e(date('Ymd', strtotime($payment->tanggal_bayar))); ?>-<?php echo e(sprintf('%04d', $payment->id)); ?></p>
            </div>
            <div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Nama Wajib Pajak</p>
                <p class="text-base font-black text-slate-900"><?php echo e($payment->tunggakan->wajibPajak->nama ?? '-'); ?></p>
            </div>
            <div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Tanggal Bayar</p>
                <p class="text-base font-black text-slate-900"><?php echo e(\Carbon\Carbon::parse($payment->tanggal_bayar)->format('d F Y')); ?></p>
            </div>
            <div class="md:col-span-2">
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Alamat Objek Pajak</p>
                <p class="text-sm font-bold text-slate-700 leading-relaxed"><?php echo e($payment->tunggakan->wajibPajak->alamat ?? '-'); ?></p>
            </div>
            <div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Tahun Pajak</p>
                <p class="text-base font-black text-slate-900"><?php echo e($payment->tunggakan->tahun ?? '-'); ?></p>
            </div>
            <div>
        ...
        <div class="border-t-2 border-slate-100 pt-8 mb-16">
            <div class="flex justify-between items-center mb-4">
                ...
                <span class="text-base font-black text-slate-900">Rp <?php echo e(number_format($payment->jumlah_bayar, 0, ',', '.')); ?></span>
            </div>
            <div class="flex justify-between items-center pb-6 mb-6 border-b-2 border-slate-900">
                ...
                <span class="text-3xl font-black text-slate-900">Rp <?php echo e(number_format($payment->jumlah_bayar, 0, ',', '.')); ?></span>
            </div>
        ...
        <div class="flex justify-between items-end">
            ...
            <div class="text-center w-64">
                ...
                <p class="text-sm font-black text-slate-900 underline"><?php echo e($payment->kolektor->nama ?? 'Petugas Loket'); ?></p>
...
<?php /**PATH C:\xampp\htdocs\pbb-cikeduk\resources\views/payments/print.blade.php ENDPATH**/ ?>