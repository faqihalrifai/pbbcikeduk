...
<div class="mb-10">
    ...
    <p class="text-sm font-medium text-slate-500">Selamat datang kembali, <span class="text-primary font-bold"><?php echo e(auth()->user()->name); ?></span></p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
    ...
    <div class="bg-white p-6 rounded-[2rem] shadow-premium border border-slate-50 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-2xl font-black text-slate-900"><?php echo e(number_format($totalWajibPajak)); ?></h3>
    ...
    <div class="bg-white p-6 rounded-[2rem] shadow-premium border border-slate-50 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-2xl font-black text-slate-900">Rp <?php echo e(number_format($totalPbb, 0, ',', '.')); ?></h3>
            <p class="text-[10px] font-bold text-emerald-500 mt-2 flex items-center gap-1">
    ...
    <div class="bg-white p-6 rounded-[2rem] shadow-premium border border-slate-50 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-2xl font-black text-slate-900">Rp <?php echo e(number_format($totalPembayaran, 0, ',', '.')); ?></h3>
            <p class="text-[10px] font-bold text-emerald-500 mt-2 flex items-center gap-1">
    ...
    <div class="bg-white p-6 rounded-[2rem] shadow-premium border border-slate-50 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-2xl font-black text-slate-900">Rp <?php echo e(number_format($totalTunggakan, 0, ',', '.')); ?></h3>
    ...
    <div class="lg:col-span-2 bg-white p-8 rounded-[2.5rem] shadow-premium border border-slate-50">
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="text-xs font-bold text-slate-400 uppercase tracking-widest">Tahun <?php echo e(date('Y')); ?></p>
            </div>
    ...
    <div class="bg-white p-8 rounded-[2.5rem] shadow-premium border border-slate-50">
        ...
        <div class="mt-8 space-y-3">
            <div class="flex justify-between items-center px-2">
                ...
                <span class="text-sm font-black text-slate-900">Rp <?php echo e(number_format($totalPembayaran, 0, ',', '.')); ?></span>
            </div>
            <div class="flex justify-between items-center px-2">
                <div class="flex items-center gap-3">
                ...
                <span class="text-sm font-black text-slate-900">Rp <?php echo e(number_format($totalTunggakan, 0, ',', '.')); ?></span>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white p-8 rounded-[2.5rem] shadow-premium border border-slate-50 mb-10">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="<?php echo e(route('payments.index')); ?>" class="text-xs font-black text-primary uppercase tracking-widest hover:underline">Lihat Semua</a>
    </div>
            ...
            <tbody>
                ...
                <tr class="group hover:bg-slate-50 transition-colors">
                    <td class="py-4 border-b border-slate-50">
                        <span class="text-xs font-bold text-slate-500"><?php echo e($pay->tunggakan->wajibPajak->nop ?? '-'); ?></span>
                    </td>
                    <td class="py-4 border-b border-slate-50">
                        <span class="text-sm font-black text-slate-900"><?php echo e($pay->tunggakan->wajibPajak->nama ?? '-'); ?></span>
                    </td>
                    <td class="py-4 border-b border-slate-50 text-right">
                        <span class="text-sm font-black text-primary">Rp <?php echo e(number_format($pay->jumlah_bayar, 0, ',', '.')); ?></span>
                    </td>
                    <td class="py-4 border-b border-slate-50 text-center">
                        <span class="text-xs font-bold text-slate-500"><?php echo e($pay->tanggal_bayar->format('d M Y')); ?></span>
                    </td>
                    <td class="py-4 border-b border-slate-50 text-center">
...
<script>
    ...
    new Chart(ctxLine, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Pembayaran',
                data: <?php echo json_encode($dataPembayaran); ?>,
                borderColor: '#3b82f6',
                borderWidth: 4,
    ...
    new Chart(ctxPie, {
        ...
        data: {
            ...
            datasets: [{
                data: [<?php echo e($totalPembayaran); ?>, <?php echo e($totalTunggakan); ?>],
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pbb-cikeduk\resources\views/dashboard/index.blade.php ENDPATH**/ ?>