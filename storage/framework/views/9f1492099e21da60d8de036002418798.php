...
<body class="text-slate-700 antialiased">
    ...
    <nav class="fixed top-0 w-full z-50 glass-nav border-b border-slate-100">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
                <a href="<?php echo e(route('landing')); ?>" class="hover:text-primary transition-colors">Beranda</a>
                <a href="<?php echo e(route('landing.informasi')); ?>" class="hover:text-primary transition-colors">Informasi PBB</a>
                <a href="<?php echo e(route('landing.balik_nama')); ?>" class="text-primary border-b-2 border-primary pb-1">Balik Nama</a>
    ...
    <main class="pt-32 pb-20 container mx-auto px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <form action="<?php echo e(route('landing.balik_nama.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-premium border border-slate-50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama_pemilik_lama" value="<?php echo e(old('nama_pemilik_lama')); ?>" placeholder="Sesuai SPPT" required
                                class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nama_pemilik_lama'];
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__errorArgs = ['nama_pemilik_lama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] font-bold text-rose-500 ml-2"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        </div>
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nop" value="<?php echo e(old('nop')); ?>" placeholder="Contoh: 32.01..." required
                                class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nop'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea name="alamat_objek" rows="3" placeholder="Alamat lengkap sesuai SPPT" required
                                class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['alamat_objek'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('alamat_objek')); ?></textarea>
                ...
                <div class="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-premium border border-slate-50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama_pemilik_baru" value="<?php echo e(old('nama_pemilik_baru')); ?>" placeholder="Sesuai KTP" required
                                class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nama_pemilik_baru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__errorArgs = ['nama_pemilik_baru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] font-bold text-rose-500 ml-2"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nik" value="<?php echo e(old('nik')); ?>" placeholder="16 Digit Angka" required
                                class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="no_hp" value="<?php echo e(old('no_hp')); ?>" placeholder="08..." required
                                class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['no_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea name="alamat_baru" rows="3" placeholder="Alamat tinggal pemilik baru" required
                                class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['alamat_baru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('alamat_baru')); ?></textarea>
                            <?php $__errorArgs = ['alamat_baru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] font-bold text-rose-500 ml-2"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <?php $__errorArgs = ['bukti_kepemilikan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] font-bold text-rose-500 ml-2"><?php echo e($message); ?></p> <?php unset($message);
...
<?php /**PATH C:\xampp\htdocs\pbb-cikeduk\resources\views/landing/balik_nama.blade.php ENDPATH**/ ?>